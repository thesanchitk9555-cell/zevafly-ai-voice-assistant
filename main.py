...
Your tasks:
1. Handle incoming calls professionally, supporting any language the user speaks and replying fluently in that exact same language.
2. Answer inquiries about Zevafly and collect user project/lead details (Name, requirement, phone number, etc.).
3. Keep responses conversational, natural, and concise (max 2-3 sentences), suitable for a phone call.
"""
...
def send_call_summary_email(user_speech: str, ai_reply: str):
    ...
    try:
        subject = "📞 New Call Update from Siya - Zevafly"
        body = f"""
        Boss Sanchit,
        
        Siya ki ek nayi call complete hui hai. Yahan uska vivaran hai:
...
async def process_speech(request: Request):
    ...
    try:
        # जेमिनी मॉडल के जरिए रिस्पॉन्स जनरेट करना (मल्टीलिंगुअल सपोर्ट)
        ...
        # बातचीत पूरी होते ही ईमेल भेजना
